...
export class ActorSheetPFNPCLite extends ActorSheetPFNPC {
  ...
  _prepareItems(data) {
    const [attacks] = data.items.reduce((arr, item) => {
    ...
    const attackSections = {
      all: { label: game.i18n.localize("PF1.Attacks"), items: [], canCreate: true, initial: true, showTypes: true, dataset: { type: "attack", "attack-type": "weapon" } },
    };
