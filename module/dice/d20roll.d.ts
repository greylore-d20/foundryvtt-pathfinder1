...
interface D20RollOptions extends D20RollConstructorOptions, Pick<D20RollChatOptions, "rollMode"> {}

interface D20RollDialogOptions extends Pick<D20RollConstructorOptions, "bonus"> {
  /**
...
interface D20ActorRollOptions
  extends Pick<D20RollConstructorOptions, "flavor" | "bonus" | "staticRoll">,
    Pick<D20RollChatOptions, "noSound" | "compendium" | "rollMode" | "chatTemplateData" | "subject" | "speaker"> {
  /**
